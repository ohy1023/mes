...
import styles from './Items.module.css'; // CSS 모듈 임포트
  ...
  return (
    <div className={styles.container}>
      ...
      <Table>
        <tbody>
          <tr>
            <td className={styles['table-label']}>회사</td>
            <td className={styles['table-control']}>
            ...
            <td className={styles['table-label']}>품목분류</td>
            <td className={styles['table-control']}>
            ...
            <td className={styles['table-label']}>품질군</td>
            <td className={styles['table-control']}>
            ...
            <td className={styles['table-label']}>거래처</td>
            <td className={styles['table-control']} style={{ width: '200px' }}>
      ...
      <Table>
        <tbody>
          <tr>
            <td className={styles['table-label']}>품목코드</td>
            <td className={styles['table-control']}>
              <Form.Control onChange={handleItemCode} value={itemCode} />
            </td>
            <td className={styles['table-label']}>품명</td>
            <td className={styles['table-control']}>
              <Form.Control
                onChange={handleItemName} value={itemName}
              />
            </td>
            <td className={styles['table-label']}>사용유무</td>
            <td className={styles['table-control']}>
              <Form.Select>
