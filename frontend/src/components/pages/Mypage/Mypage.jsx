              ...
              <div className={[styles.MemberCard, styles.Clearfix].join(" ")}>
                <div className={styles.MemberCardBody}>
                  <div className={[styles.Avatar, styles.TwMb2].join(" ")}>
                    {imageUrl === 'null' ? (
                      <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png" alt="profile_image" />
                    ) : (
              ...
              <div className={styles.MemberCard}>
                ...
                <div className={styles.MemberCardBody}>
                  <ul className={styles.MemberInfoList}>
                    <li>
                      <label htmlFor="email_address">
                        이메일 주소<span className={styles.Required}>필수</span>
                      </label>
                      <div>{email}</div>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <div>
                        {imageUrl === 'null' ? (
                          <img src='https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png' alt="이미지" />
                        ) : (
                  ...
                  <div className={[styles.TwFlex, styles.TwFlewWrap].join(" ")}>
                    <a href="mypage/password/validation" className={[styles.Link, styles.TwMr3].join(" ")}>
                      회원정보 변경
                    </a>
                    <a href="mypage/password/modify" className={[styles.Link, styles.TwMr3].join(" ")}>
                      비밀번호 변경
                    </a>
                    <div className={styles.TwFlex1}></div>
                    <a href="#/" onClick={deleteHandler} className={[styles.Link, styles.TwTextDanger].join(" ")}>
                      탈퇴
                    </a>
                    <DeleteUser
